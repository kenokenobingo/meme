/*
 *  vercmp.c - Compare package version numbers using meme's version
 *      comparison logic
 *
...
{
	fprintf(stderr, "vercmp (meme) v" PACKAGE_VERSION "\n\n"
		"Compare package version numbers using meme's version comparison logic.\n\n"
